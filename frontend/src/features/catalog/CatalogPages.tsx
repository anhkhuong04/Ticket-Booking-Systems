...
export function HomePage() {
  ...
  return <main className="bg-background pb-16"><div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    ...
    <section className="mt-8 rounded-xl border border-border bg-surface p-5"><h2 className="text-lg font-semibold">Đặt vé nhanh</h2><p className="mt-1 text-sm text-text-secondary">Chọn phim và chi nhánh để xem suất chiếu phù hợp.</p><Link className="mt-4 inline-flex min-h-11 items-center rounded-lg border border-primary px-4 text-sm font-semibold text-primary hover:bg-primary-soft" to="/movies">Tìm phim</Link></section>
